...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "f24a0b99-36fd-4ac1-9928-8fddd75a207b");
    form.append("name", formData.name);
    form.append("email", formData.email);
    form.append("subject", formData.subject || "New Contact Form Submission");
    form.append("message", formData.message);
    /*form.append("honeypot", ""); // Optional: Add a honeypot field to prevent spam*/
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-300 text-lg">
                  Want to work together? Leave a message!
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">tkyeicharway@gmail.com </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+233 59 269 6949</p>
                  </div>
                </div>
              </div>
            </div>
